...
"""
    plot_ternary(plot_data)

Compose ternary diagram from a PhaseDiagram.
"""
function EDDPotentials.plot_ternary(phased::PhaseDiagram)
    _make_ternary_plot(EDDPotentials.get_ternary_hulldata(phased))
end

function _make_ternary_plot(plot_data)
...
"""
plot_binary_plotly(ps::EDDPotentials.PhaseDiagram) =  _make_binary_hull_plotly(EDDPotentials.get_2d_plot_data(ps))
...
"""
function _make_binary_hull_plotly(data)
