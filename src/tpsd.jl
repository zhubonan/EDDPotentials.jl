...
TwoPointSteepestDescent(;α_init=1e-8, manifold=Optim.Flat()) = TwoPointSteepestDescent(α_init, manifold)
...
function Optim.update_state!(d, state::TPSDState, method::TwoPointSteepestDescent{T}) where {T}
...
function Optim.trace!(tr, d, state, iteration, method::TwoPointSteepestDescent, options, curr_time=time())
