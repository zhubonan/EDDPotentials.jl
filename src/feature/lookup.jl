...
function FeatureLookup(cf::CellFeature)
    ...
    FeatureLookup(two_body, two_body_end, three_body, three_body_end, ne, elements)
end
...
lookup(cf::CellFeature, i::Symbol, j::Symbol, k::Symbol) =
    lookup(FeatureLookup(cf), i, j, k)
