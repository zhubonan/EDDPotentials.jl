...
cell = Cell(Lattice([10, 10, 10, 90, 90, 90.]), [:Al, :Al],  [0 1.; 0 0; 0 0])
x = LinRange(1, 5, 100)
...
function plot_lj(builder, x=LinRange(1,5, 100))
    p = plot(x, pp3_out, label="LJ", xlim=(1.5, 5), 
            ylim=(-3, 10), xlabel="Distance", ylabel="Energy", linewidth=5)
    for iter in 0:builder.state.iteration
