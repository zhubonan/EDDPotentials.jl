...
#     nl = NeighbourList(cell, 6.0;savevec=true)
#     wk = EDDPotentials.get_workspace(cf, nl)
#     EDDPotentials.compute_fv!(wk, cf.two_body, cf.three_body, cell;nl=nl, offset=n1bd)
#     fvec = copy(wk.fvec)
...
#     gtot = gvec_index_transfer(calc.workspace)
